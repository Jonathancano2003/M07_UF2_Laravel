...
<div class="container mt-5">
    ...
    <form action="" method="GET" class="mb-4" id="decadeForm">
...
<div class="container mt-5">
    ...
    <form action="" method="GET" class="mb-4" id="decadeForm">
        <label for="decade">Selecciona una década:</label>
        <select name="year" id="decade" class="form-control" onchange="document.getElementById('decadeForm').action = '{{ url('actors/decade') }}/' + this.value; document.getElementById('decadeForm').submit();">
